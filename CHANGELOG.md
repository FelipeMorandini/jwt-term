...
- HMAC (HS256/384/512), RSA (RS256/384/512, PS256/384/512), ECDSA (ES256/384), EdDSA support
...
- Modified reqwest to use `rustls-tls` for Linux musl cross-compilation compatibility
...
- Colorized JSON printer (cyan keys, green strings, yellow numbers, magenta bools, red null)
- Token status display (exp/iat/nbf with color-coded expiry)
- `--json` mode for machine-readable output
- Custom Debug redaction on DecodedToken
...
[0.3.0]: https://github.com/felipemorandini/jwt-term/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/felipemorandini/jwt-term/compare/v0.1.2...v0.2.0
[0.1.2]: https://github.com/felipemorandini/jwt-term/compare/v0.1.1...v0.1.2
[0.1.1]: https://github.com/felipemorandini/jwt-term/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/felipemorandini/jwt-term/releases/tag/v0.1.0
